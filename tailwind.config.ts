  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'premium-gradient': 'linear-gradient(135deg, #1E3A8A 0%, #EA580C 50%, #2ECC71 100%)',
        'hero-gradient': 'linear-gradient(135deg, rgba(30,58,138,0.95) 0%, rgba(234,88,12,0.9) 100%)',
        'card-gradient': 'linear-gradient(145deg, #ffffff 0%, #f8fafc 100%)',
        'accent-gradient': 'linear-gradient(135deg, #EA580C 0%, #F39C12 100%)',
      },
      boxShadow: {
